...
@Controller('api/personal-reference')
export class PersonalReferenceController {
    ...
    async create(@Body() data: CreatePersonalReferenceDto, @Res() res: Response) {
        try {
            const personalReference = await this.personalReferenceService.create(data);
    ...
    @Patch(':id')
    async update(@Param('id') id: string, @Body() data: UpdatePersonalReferenceDto, @Res() res: Response) {
        try {
            const personalReference = await this.personalReferenceService.update(id, data);
    ...
    async getAll(@Param('userId') userId: string, @Res() res: Response) {
        try {
            const personalReferences = await this.personalReferenceService.getAll(userId);
