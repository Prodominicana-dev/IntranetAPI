...
export class ApplicationService {
    ...
    async create(data: any) {
        try {
            const application = await this.primsmaService.application.create({ data });
            return application;
        } catch (error) {
            console.log(error)
    ...
    async update(id: string, data: any) {
        try {
            const application = await this.primsmaService.application.update({ where: { id }, data });
            return application;
        } catch (error) {
            console.log(error)
    ...
    async delete(id: string) {
        try {
            const application = await this.primsmaService.application.delete({ where: { id } });
            return application;
        } catch (error) {
            console.log(error)
    ...
    async getById(id: string) {
        try {
            const application = await this.primsmaService.application.findUnique({ where: { id } });
            return application;
        } catch (error) {
            console.log(error)
    ...
    async approvedUpdate(id: string) {
      try {
        const  approved = await this.primsmaService.application.update({ where: { id }, data: { status: '' } });
        return  approved;
      } catch (error) {
        console.log(error);
    ...
    async approvedGetAll(id: string) {
        try {
          const  approved = await this.primsmaService.application.findMany({ where: { userId: id } });
          return  approved;
        } catch (error) {
          console.log(error);
          throw new Error('Error en obtener las  aprobaciones de las Aplicaciones ');
        }
    }
    ...
    async approvedGetById(id: string) {
        try {
          const  approved = await this.primsmaService.application.findUnique({ where: { id } });
          return  approved;
        } catch (error) {
          console.log(error);
    ...
    async dismissedUpdate(id: string) {
        try {
          const  dismissed = await this.primsmaService.application.update({ where: { id }, data: { status: '' } });
          return  dismissed;
        } catch (error) {
          console.log(error);
    ...
    async dismissedGetAll(id: string) {
        try {
          const  dismissed = await this.primsmaService.application.findMany({ where: { userId: id } });
          return  dismissed;
        } catch (error) {
          console.log(error);
    ...
    async dismissedGetById(id: string) {
        try {
          const  demissed = await this.primsmaService.application.findUnique({ where: { id } });
          return  demissed;
        } catch (error) {
          console.log(error);
