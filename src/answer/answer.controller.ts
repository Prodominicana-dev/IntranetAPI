...
export class AnswerController {
    ...
    @Patch(':id')
    async update(@Param('id') id: string, @Body() data: UpdateAnswerDto, @Res() res: Response){
        try {
    ...
    async getAll(@Param('questionId') questionId: string, @Param('userId') userId: string, @Res() res: Response){
        try {
